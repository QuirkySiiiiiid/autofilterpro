...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002249464432 -1002125588996 -1002008657265 -1002008657265').split()]  # Channel id for auto indexing (make sure bot is admin)
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001637425340').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'Zoro'))
MULTI_CLIENT = False
